...
<?php
    ...
    if ($check->rowCount() > 0) {
        ...
        genero, direccion, cod_postal, poblacion, provincia)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $pdo->prepare($sql);
        $stmt->execute([$_POST[ "nombre"],$_POST[ "apellidos"],$_POST[ "email"],$_POST[ "password"],$_POST[ "genero"],
        $_POST[ "direccion"],$_POST[ "cod_postal"],$_POST[ "poblacion"],$_POST[ "provincia"]]);
...
<div class="card">
    ...
    <div class="card-body">
        <form action="ins_cli_pdo.php" method="post">
            <div class="row">
