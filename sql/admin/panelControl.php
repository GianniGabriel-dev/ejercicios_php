...
<body>
    <!--Aside-->
    <aside style="width: 300px;" class="p-3  bg-secondary-subtle h-100 position-absolute top-0">
    ...
    <main class="container min-vh-100 d-flex justify-content-center align-items-center">
        <div class="row row-cols-1 row-cols-md-3 g-5 justify-content-center">
            ...
            <a class="col d-flex justify-content-center text-decoration-none"
                href="videojuegos/gestion_videojuegos.php">
                <div class="card card-hover text-primary-emphasis align-items-center justify-content-center text-center"
                    style="width: 250px; height: 220px;">
                    <svg width="80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                        <path fill="currentColor"
            ...
            <?php
                if ($rol == 1) {
                    echo '
                        <a class="col d-flex justify-content-center text-decoration-none" href="./usuarios/gestion_usuarios.php">
                            <div class="card card-hover text-primary-emphasis align-items-center justify-content-center text-center"
                            style="width: 250px; height: 220px;">
                            <svg width="80" data-slot="icon" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path d="M4.5 6.375a4.125 4.125 0 1 1 8.25 0 4.125 4.125 0 0 1-8.25 0ZM14.25 8.625a3.375 3.375 0 1 1 6.75 0 3.375 3.375 0 0 1-6.75 0ZM1.5 19.125a7.125 7.125 0 0 1 14.25 0v.003l-.001.119a.75.75 0 0 1-.363.63 13.067 13.067 0 0 1-6.761 1.873c-2.472 0-4.786-.684-6.76-1.873a.75.75 0 0 1-.364-.63l-.001-.122ZM17.25 19.128l-.001.144a2.25 2.25 0 0 1-.233.96 10.088 10.088 0 0 0 5.06-1.01.75.75 0 0 0 .42-.643 4.875 4.875 0 0 0-6.957-4.611 8.586 8.586 0 0 1 1.71 5.157v.003Z"></path>
                            </svg>
                            <h3 class="card-title mt-3">Gestión usuarios</h3>
                            </div>
                         </a>
                    ';
                }
