    ...
    <main class="container min-vh-100 d-flex justify-content-center align-items-center">
        <div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center">
            ...
            <div class="col d-flex justify-content-center">
                <div class="card text-primary-emphasis align-items-center justify-content-center text-center"
                    ...
                    <h5 class="card-title mt-3">Gestión clientes</h5>
                </div>
            </div>
            ...
            <div class="col d-flex justify-content-center">
                <div class="card text-primary-emphasis align-items-center justify-content-center text-center"
                    ...
                    <h5 class="card-title mt-3">Videojuegos</h5>
                </div>
            </div>
            ...
            <div class="col d-flex justify-content-center">
                <div class="card text-primary-emphasis align-items-center justify-content-center text-center"
                    ...
                    <h5 class="card-title mt-3">Salir</h5>
                </div>
            </div>
