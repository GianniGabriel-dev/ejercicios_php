...
<body>
    <main class="container-fluid min-vh-100 w-100 d-flex flex-column justify-content-center align-items-center">
        <div class="row justify-content-center align-items-center gap-4 mb-4" >
            <div class="card col-4  align-items-center text-primary-emphasis">
            ...
            <div class="card col-4 text-primary-emphasis align-items-center">
                <svg width="80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
